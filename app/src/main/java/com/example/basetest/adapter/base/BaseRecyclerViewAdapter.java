...
import com.example.basetest.listener.OnItemLongClickListener;
...
public abstract class BaseRecyclerViewAdapter<T, VH extends BaseRecyclerViewAdapter.SparseArrayViewHolder> extends
    ...
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        return (VH) new SparseArrayViewHolder(inflateItemView(parent, inflateLayoutRes()));
    }
    ...
    public static class SparseArrayViewHolder extends RecyclerView.ViewHolder {
        ...
        public SparseArrayViewHolder setInvisible(int viewId) {
            View view = getView(viewId);
