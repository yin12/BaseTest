 ...
 * @author 张磊
 */
public class AHTobaccosMobileService {
    private static AHTobaccosMobileService ahtobaccoMobileService;

    private AHTobaccosMobileService() {
    }

    public static AHTobaccosMobileService getInstance() {
        if (ahtobaccoMobileService == null) {
            ahtobaccoMobileService = new AHTobaccosMobileService();
        }
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    XML xml = Utils.getXML(xmlResult);
                    Node root = xml.getRoot();
                    String result = root.getAttribute("result");
